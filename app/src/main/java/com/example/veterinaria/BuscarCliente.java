...
public class BuscarCliente extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void BuscarClientes(View view) {
        String url = "http://192.168.0.4/veterinaria/wsJSONBuscarClienteTodo.php?cedula=" + txtCedula.getText().toString();
    ...
    public void ActualizarCliente (View view){
        String url="http://192.168.0.4/veterinaria/wsJSONUpdateCliente.php?";
    ...
    public void Eliminarcliente (View view){
        ...
        String url = "http://192.168.0.4/veterinaria/wsJSONADeleteCliente.php?cedula="+txtCedula.getText().toString();
