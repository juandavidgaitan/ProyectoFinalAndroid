...
CtlGuardarMascota guardarMascota;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistrarMascota.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegistrarMascota("http://192.168.0.5/veterinaria/RegistrarMascota.php");
            }
        });
        ...
        btnBuscarMascota.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarMascotaTodo("http://192.168.0.5/veterinaria/BuscarMascota.php?id_mascota=" + txtId_mascota.getText()+"");
            }
        });
    ...
    public void BuscarCliente(View view) {
        String url = "http://192.168.0.5/veterinaria/wsJSONBuscarCliente.php?cedula=" + txtDueno.getText().toString();
    ...
    public void ActualizarMascota (View view){
        String url="http://192.168.0.5/veterinaria/wsJSONUpdateMascota.php?";
    ...
    public void EliminarMascota(View view){
        ...
        String url = "http://192.168.0.5/veterinaria/wsJSONADeleteMascota.php?id_mascota="+txtId_mascota.getText().toString();
