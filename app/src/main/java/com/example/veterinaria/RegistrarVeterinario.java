...
public class RegistrarVeterinario extends AppCompatActivity   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistarVeterinario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegistrarVeterinario("http://192.168.0.5/veterinaria/RegistrarVeterinario.php");
            }
        });
        ...
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarVete("http://192.168.0.5/veterinaria/BuscarVeterinaria.php?nit_veterinaria=" + txtNit_Veterinaria.getText()+"");
            }
        });
        btnBuscarVeterinario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarVeterinario("http://192.168.0.5/veterinaria/BuscarVeterinario.php?cedula=" + txtCedula.getText()+"");
            }
        });
    }
    ...
    public void ActualizarVeterinario (View view){
        String url="http://192.168.0.5/veterinaria/wsJSONUpdateVeterinario.php?";
    ...
    public void EliminarVete (View view){
        ...
        String url = "http://192.168.0.5/veterinaria/wsJSONADeleteVeterinario.php?cedula="+txtCedula.getText().toString();
