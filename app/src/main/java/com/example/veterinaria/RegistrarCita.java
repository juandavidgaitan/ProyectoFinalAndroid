...
public class RegistrarCita  extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegistrarCita.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RegistrarCita("http://192.168.0.5/veterinaria/RegistrarCita.php");
            }
        });
        btnBuscarcita.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarCita("http://192.168.0.5/veterinaria/BuscarCita.php?id_cita=" + txtId_cita.getText()+"");
            }
        });
        ...
        btnBuscarVeterinaria.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarVeterinaria("http://192.168.0.5/veterinaria/BuscarVeterinaria.php?nit_veterinaria=" + txtNit_Veterinaria.getText()+"");
            }
        });
        ...
        btnBuscarMascota.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BuscarMascota("http://192.168.0.5/veterinaria/BuscarMascota.php?id_mascota=" + txtMascotaid.getText()+"");
            }
        });
    }
    ...
    public void ActualizarCita (View view){
        ...
        String url="http://192.168.0.5/veterinaria/wsJSONUpdateCita.php?";
    ...
    public void EliminarCita (View view){
        ...
        String url = "http://192.168.0.5/veterinaria/wsJSONADeleteCita.php?id_cita="+txtId_cita.getText().toString();
